...
// });
	...
	const enableSwiper = function() {
	  ...
	  mySwiper = new Swiper('.reviews__content', {
		observer: true,
		observeParents: true,
		slidesPerView: 1,
		spaceBetween: 0,
...
function handleMapMove(e) {
	if (e.touches.length == 1) {
		...
		newDiv.textContent = 'Чтобы переместить карту проведите по ней двумя пальцами';
		document.cont_map.appentChild(newDiv)
